...
const TEMPLATE_COLUMNS = [
    ...
    { header: 'Tanggal Lahir (YYYY-MM-DD)', key: 'birthDate', required: false },
    ...
    { header: 'Tanggal Masuk (YYYY-MM-DD)', key: 'enrollmentDate', required: false },
...
export default function UploadSantriPage() {
    ...
    const downloadTemplate = () => {
        const ws = XLSX.utils.aoa_to_sheet([TEMPLATE_COLUMNS.map(c => c.header)])
        // Set column widths
        ws['!cols'] = TEMPLATE_COLUMNS.map(c => ({ wch: c.header.length + 5 }))
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-slate-500 mt-1">Download template Excel lalu isi data santri. Kolom <strong>NIS</strong> dan <strong>Nama Lengkap</strong> wajib diisi, kolom lainnya opsional.</p>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
                    <div className="flex items-center justify-between">
                        <h3 className="text-base font-bold text-slate-800">
                            3. Preview Data ({parsedRows.length} baris)
                        </h3>
            ...
            {result && typeof document !== 'undefined' && createPortal(
                <div className="fixed inset-0 z-[9999] bg-black/45 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setResult(null)}>
                    <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl space-y-5 animate-fade-in" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="flex gap-3">
                            ...
                            <button onClick={() => router.push('/master-data/santri/manage')}
