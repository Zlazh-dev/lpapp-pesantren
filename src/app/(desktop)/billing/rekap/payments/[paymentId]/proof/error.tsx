...
export default function PaymentProofByPaymentError({
    error,
    reset,
}: {
    ...
    if (process.env.NODE_ENV !== 'production') {
        console.error('[payment-proof-viewer-payment]', error)
    }

    return (
        <div className="mx-auto max-w-3xl rounded-2xl border border-red-200 bg-white p-6">
            <h1 className="text-lg font-semibold text-slate-900">Gagal memuat bukti pembayaran</h1>
