...
export default function PaymentProofByPaymentNotFound() {
    return (
        <div className="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-6">
            <h1 className="text-lg font-semibold text-slate-900">Pembayaran Tidak Ditemukan</h1>
            <p className="mt-2 text-sm text-slate-600">
                Data pembayaran tidak ditemukan atau sudah tidak tersedia.
            </p>
            <div className="mt-4">
                <Link
                    href="/billing/rekap"
