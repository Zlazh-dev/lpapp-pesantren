...
export default function AkademikSantriDetailPage({ params }: { params: Promise<{ id: string }> }) {
    const { id } = use(params)
        ...
        return (
            <div className="max-w-5xl mx-auto">
                <div className="rounded-2xl border border-red-200 bg-red-50 px-6 py-10 text-center">
                    ...
                    <Link href="/akademik/santri" className="mt-5 inline-flex px-5 py-2.5 rounded-xl border border-red-300 bg-white text-sm font-medium text-red-700 hover:bg-red-50 transition-all">
                        ← Kembali ke List
                    </Link>
                </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto space-y-6 animate-fade-in">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <Link href="/akademik/santri" className="p-2.5 rounded-xl border border-slate-200 bg-white text-slate-400 hover:text-teal-600 hover:border-teal-200 hover:shadow-sm transition-all">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                        </svg>
                    </Link>
                    <h1 className="text-2xl font-bold text-slate-800">Detail Santri</h1>
                    <span className="rounded-full bg-blue-50 border border-blue-200 px-2.5 py-0.5 text-[11px] font-semibold text-blue-700">Madrasah</span>
                </div>
                <div className="relative" ref={menuRef}>
                    ...
                    {showMenu && (
                        <div data-kebab className="absolute right-0 top-full mt-2 w-52 rounded-xl border border-slate-200 bg-white shadow-xl shadow-slate-200/50 py-1.5 z-50 animate-fade-in">
                            <Link href={`/akademik/santri/${id}/request`}
